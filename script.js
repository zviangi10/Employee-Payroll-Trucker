...
const collectEmployees = function() {
    ...
    while (continueAddding) {
        let firstName = prompt('Add First Name');
        let lastName = prompt('Add Last Name');
        let employeeSalary = promp('Add Salary');

        //Created a while loop to promt user input
        let salary = 0;

        let_tsalary = prompt("Get Salary");

        salary = (isNaN(let_tsalary)  || let_tsalary === null) ? 0 : Number(let_tsalary);
        ...
        const newLocal = continueAdding = confirm('You Want To Add Another Employee?');
